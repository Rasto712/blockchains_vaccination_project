...
3. Implement grants keyed by owner/requester/scope with duration 1-365 days. Check exact requester and scope; deny at expiry. Own-grant revocation must not affect another guardian.
